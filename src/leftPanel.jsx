      ...
      <div className="lp-head">
        <div className="lp-head-top">
          <div className="lp-logo-wrap" ref={menuRef}>
            <button className={`lp-logo has-tip ${menuOpen ? "open" : ""}`} aria-label="Main menu"
              ...
              <span className="ui-tip left">goodAds.ai</span>
            </button>
            {menuOpen && (
          ...
          <button className="icon-btn lp-collapse has-tip" aria-label="Minimize UI">
            <Icon.PanelLeft size={16} />
            <span className="ui-tip right">Minimize UI</span>
          </button>
        </div>
